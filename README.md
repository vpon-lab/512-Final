...
# Tilt It! "Block"-it Block Shaped Bop It — A 90s-Style Handheld Reaction Game
...
- 3D-printed enclosure (non-yellow)
...
- Printed in a non-yellow filament per project requirements  
